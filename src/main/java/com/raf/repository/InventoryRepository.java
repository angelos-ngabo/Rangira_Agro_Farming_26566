...
List<Inventory> findByStatus(InventoryStatus status, Sort sort);
List<Inventory> findByQualityGrade(String qualityGrade);
List<Inventory> findByQualityGrade(String qualityGrade, Sort sort);

List<Inventory> findByWarehouseIdAndStatus(Long warehouseId, InventoryStatus status);
List<Inventory> findByWarehouseIdAndStatus(Long warehouseId, InventoryStatus status, Sort sort);
List<Inventory> findByFarmerIdAndStatus(Long farmerId, InventoryStatus status);
List<Inventory> findByFarmerIdAndStatus(Long farmerId, InventoryStatus status, Sort sort);
