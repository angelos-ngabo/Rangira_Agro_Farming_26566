...
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler", "transactions", "transactionsAsBuyer", "transactionsAsSeller", "inventoriesAsFarmer", "inventoriesAsStorekeeper", "enquiriesAsBuyer", "enquiriesAsFarmer", "wallet", "notifications", "payments", "warehouseAccesses", "ratingsGiven", "ratingsReceived"})
@ToString.Exclude
private User buyer;
...
@JsonManagedReference("enquiry-transaction")
@ToString.Exclude
